        ...
        require("easytables").setup({
            ...
            set_mappings = function(buf)
                vim.keymap.set("n", "h", function()
                    vim.cmd("silent! JumpLeft")
                end, { buffer = buf })
                vim.keymap.set("n", "H", function()
                    vim.cmd("silent! SwapWithLeftCell")
                end, { buffer = buf })

                vim.keymap.set("n", "l", function()
                    vim.cmd("silent! JumpRight")
                end, { buffer = buf })
                vim.keymap.set("n", "L", function()
                    vim.cmd("silent! SwapWithRightCell")
                end, { buffer = buf })

                vim.keymap.set("n", "k", function()
                    vim.cmd("silent! JumpUp")
                end, { buffer = buf })
                vim.keymap.set("n", "K", function()
                    vim.cmd("silent! SwapWithUpperCell")
                end, { buffer = buf })

                vim.keymap.set("n", "j", function()
                    vim.cmd("silent! JumpDown")
                end, { buffer = buf })
                vim.keymap.set("n", "J", function()
                    vim.cmd("silent! SwapWithLowerCell")
                end, { buffer = buf })
                ...
                vim.keymap.set("n", "<Tab>", function()
                    vim.cmd("silent! JumpToNextCell")
                end, { buffer = buf })
                vim.keymap.set("i", "<Tab>", function()
                    vim.cmd("silent! JumpToNextCell")
                end, { buffer = buf })
                vim.keymap.set("n", "<S-Tab>", function()
                    vim.cmd("silent! JumpToPreviousCell")
                end, { buffer = buf })
                ...
                vim.keymap.set("n", "<C-l>", function()
                    vim.cmd("silent! SwapWithRightColumn")
                end, { buffer = buf })
                vim.keymap.set("n", "<C-k>", function()
                    vim.cmd("silent! SwapWithUpperRow")
                end, { buffer = buf })
                vim.keymap.set("n", "<C-j>", function()
                    vim.cmd("silent! SwapWithLowerRow")
                end, { buffer = buf })
            end,
        })
    end,
